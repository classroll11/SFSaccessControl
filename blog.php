    ...
    <main class="page-container">
        ...
        <div class="blog-grid">
            ...
            <div class="blog-card">
                ...
                <h3>Control de Raciones PAE</h3>
                <p>El personal del restaurante escolar conoce el aforo exacto de estudiantes en el colegio, optimizando porciones y reduciendo desperdicios.</p>
            </div>
